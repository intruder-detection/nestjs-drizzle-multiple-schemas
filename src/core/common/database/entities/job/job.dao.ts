...
import { JobEntity, jobs } from '@core/common/database/entities/job/job.entity';

@Injectable()
export class JobDao extends AbstractDao<typeof jobsSchema, typeof jobs, JobEntity> {
  constructor(
